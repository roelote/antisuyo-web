...
<head>
    ...
    <title>Blog colonial Lima | Antisuyo Trek Perú | Travel and tourism agency in Peru</title> 
        ...
        <div class="col-md-9" id="single_tour_desc">
            <div class="row">
                ...
                <div class="col-md-10 descripcion">
                    <h4>Colonial Lima</h4>
                    <p>The historic center of Lima is the area of <strong><a href="../lima-paracas-nazca-arequipa-puno-cusco-machu-picchu">the city of Lima</a></strong> covering its original location and its oldest buildings. The complex, located between the districts of <strong>Lima</strong> and <strong>Rimac</strong> , was declared a World Heritage Site in 1988 and is one of the most important tourist destinations in <strong>Peru</strong>.</p> 
                </div> 
            </div>
            <hr> 
			<div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6">
                            <ul class="list-inline">
                                <li><i class="icon_set_1_icon-38"></i>-12.048099 South latitude</li> 
                            </ul>
                        </div>
                        <div class="col-md-6 col-sm-6">
                            <ul class="list-inline">
                                <li><i class="icon_set_1_icon-38"></i>-77.072986 west longitude</li> 
                            </ul>
                        </div>
                    </div> 
                </div> 
            ...
            <div class="row">
                ...
                <div class="col-md-10 descripcion">  
                    <p>Peru's central coast, shows a series of atypical microclimates due to the influential and cold Humboldt current that results from Antarctica, the proximity of the Andes and its geographical location, giving Lima a subtropical climate, cool, desert and wet while</p> 
                </div><!-- End col-md-9  -->
            </div>
			<hr>
            <div class="row">
                ...
                <div class="col-md-10 descripcion">
                    <p>It was erected as Ciudad de los Reyes by the Spanish conquistador Francisco Pizarro on January 18, 1535 in the settlement of the area known as limaq in relation to the oracle named Huaca de Santa Ana, shortly thereafter. Later, the place name 'Lima' Cornering use Spanish name of the city. In the first maps of Peru you can be seen the name of Lima in conjunction with the City of Kings.</p> 
                </div><!-- End col-md-9  -->
            </div>
