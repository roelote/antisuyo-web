<?php
$nombre_paquete = ' Cusco Machu Picchu Classic Optional ';
$numero_dias='3 Days and 2 Nights';
$nombre_completo_paquete=$nombre_paquete." ".$numero_dias;
$descripcion_tour="The optional Classic Cusco Package Machu Picchu 3 days and 2 nights is an option for people who are in the city of Cusco and also the historic sanctuary of Machu Picchu.";
...
$url_foto_seo="https://www.antisuyotrekperu.com/img/tours-machu-picchu/classic-cusco-optional-3-days-2-nights/hotel-transfer.jpg";
...
<![endif]-->
    ...
    <?php include("includes/menu.php"); ?>
      <section class="slider-tours">
        ...
        <div class="fill-tour" style="background-image:url('img/tours-machu-picchu/classic-cusco-optional-3-days-2-nights.jpg');"></div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-4">
                    <div id="price_single_main" class="hotel">
                       Price from<span><sup>$</sup>360</span>For Person
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row ">
        <div class="col-md-9" id="single_tour_desc">
					...
					<div class="row magnific-gallery">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/tours-machu-picchu/classic-cusco-optional-3-days-2-nights/hotel-transfer.jpg" title="Hotel Transfer."><img src="img/tours-machu-picchu/classic-cusco-optional-3-days-2-nights/hotel-transfer.jpg" title="Hotel Transfer." alt="Hotel Transfer" class="img-responsive">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/tours-machu-picchu/classic-cusco-optional-3-days-2-nights/free-day-for-acclimatization.jpg" title="Free day for acclimatization."><img src="img/tours-machu-picchu/classic-cusco-optional-3-days-2-nights/free-day-for-acclimatization.jpg" alt="Free day for acclimatization." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/tours-machu-picchu/classic-cusco-optional-3-days-2-nights/overnight-in-cusco.jpg" title="Overnight in Cusco."><img src="img/tours-machu-picchu/classic-cusco-optional-3-days-2-nights/overnight-in-cusco.jpg" title="Overnight in Cusco." alt="Overnight in Cusco." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
                ...
                <div class="col-md-10"> 
                 <div class="form_title"><h3><strong><i class="icon_set_1_icon-68"></i></strong><span>Day 2</span></h3> 
					...
					<div class="row magnific-gallery">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/tours-machu-picchu/classic-cusco-optional-3-days-2-nights/the-intiwatana.jpg"><img src="img/tours-machu-picchu/classic-cusco-optional-3-days-2-nights/the-intiwatana.jpg" title="The Intihuatana." alt="The Intihuatana." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/tours-machu-picchu/classic-cusco-optional-3-days-2-nights/the-sun-temple.jpg" title="Sun Temple."><img src="img/tours-machu-picchu/classic-cusco-optional-3-days-2-nights/the-sun-temple.jpg" alt="Sun Temple." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
                ...
                <div class="col-md-10"> 
                 <div class="form_title"><h3><strong><i class="icon_set_1_icon-68"></i></strong><span>Day 3</span></h3> 
					...
					<div class="row magnific-gallery">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/tours-machu-picchu/classic-cusco-optional-3-days-2-nights/breakfast-at-the-hotel.jpg" title="Breakfast at the Hotel."><img src="img/tours-machu-picchu/classic-cusco-optional-3-days-2-nights/breakfast-at-the-hotel.jpg" alt="Breakfast at the Hotel." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/tours-machu-picchu/classic-cusco-optional-3-days-2-nights/hotel-exit.jpg" title="Hotel exit."><img src="img/tours-machu-picchu/classic-cusco-optional-3-days-2-nights/hotel-exit.jpg" alt="Hotel exit." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/tours-machu-picchu/classic-cusco-optional-3-days-2-nights/airport-transfer.jpg" title="Airport transfer."><img src="img/tours-machu-picchu/classic-cusco-optional-3-days-2-nights/airport-transfer.jpg" title="Airport transfer" alt="Airport transfer." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
           ...
           <div class="row">
                ...
                <div class="col-md-10"> <a href="https://www.google.com/maps/d/embed?mid=1vk7zDoMBAYBjGBQzZLBCEGZL9Uk" target="_blank"><img src="../img/see map.png"></a>  
                </div>    
            </div>
            <hr>
