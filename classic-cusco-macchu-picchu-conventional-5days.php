<?php
$nombre_paquete = 'Conventional Classic Cusco Machu Picchu';
$numero_dias='5 Days and 4 Nights';
$nombre_completo_paquete=$nombre_paquete." ".$numero_dias;
$descripcion_tour="This package of 5 days and 4 nights is an alternative to know the historical sanctuary of Machu Picchu, during the trip from Cusco to the town of Aguas Calientes and Machu Picchu, we can take advantage of seeing the beautiful landscapes, such as: Picturesque villages, mountains, rivers and snow-capped mountains of the Andes.";
...
$url_foto_seo="https://www.antisuyotrekperu.com/img/tours-machu-picchu/classic-cusco-conventional-5-days-4-nights/hotel-transfer.jpg";
...
<![endif]-->
    ...
    <?php include("includes/menu.php"); ?>
      <section class="slider-tours">
          <div class="fill-tour" style="background-image:url('img/tours-machu-picchu/classic-cusco-conventional-5-days-4-nights.jpg');"></div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-4">
                    <div id="price_single_main" class="hotel">
                       Price from<span><sup>$</sup>510</span>For Person
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-9" id="single_tour_desc">
            ...
            <div class="row">
                ...
                <div class="col-md-10 descripcion"> 
					 <p>This package of 5 days and 4 nights is an alternative to know the <strong>historical sanctuary of Machu Picchu</strong>, during the trip from <strong>Cusco</strong> to the town of <strong>Aguas Calientes</strong> and <strong>Machu Picchu</strong>, we can take advantage of seeing the beautiful landscapes, such as: Picturesque villages, mountains, rivers and snow-capped <strong>mountains of the Andes</strong>.</p>                   
                    ...
                    <p>It is believed that <strong>Machu Picchu</strong> had a population like most “<strong>Llactas Incas</strong>”, that was between the 300 and 1000 inhabitants that were possibly part of the Panaca of <strong>Pachacutec</strong>.</p>                    
                    <p><strong>Machu Picchu</strong> has been on UNESCO's World Heritage List since 1983, as part of an entire cultural and ecological complex known as the Historic Sanctuary of <strong>Machu Picchu</strong>. On July 7, 2007, <strong>Machu Picchu</strong> was declared one of the Seven Wonders of the Modern World, at a ceremony held in Lisbon, Portugal, with the participation of one hundred million voters worldwide, choosing <strong>Machu Picchu</strong> as one from them.</p>
                   </div>
            </div>
          	<hr>
            <div class="row">
					...
					<div class="row magnific-gallery">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/tours-machu-picchu/classic-cusco-conventional-5-days-4-nights/hotel-transfer.jpg" title="Hotel transfer."><img src="../img/tours-machu-picchu/classic-cusco-conventional-5-days-4-nights/hotel-transfer.jpg" alt="Hotel transfer." class="img-responsive">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/tours-machu-picchu/classic-cusco-conventional-5-days-4-nights/rest-in-the hotel.jpg" title="Rest in the Hotel."><img src="../img/tours-machu-picchu/classic-cusco-conventional-5-days-4-nights/rest-in-the hotel.jpg" alt="Rest in the Hotel." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/tours-machu-picchu/classic-cusco-conventional-5-days-4-nights/free-day-for-acclimatization.jpg" title="Free day for acclimatization."><img src="../img/tours-machu-picchu/classic-cusco-conventional-5-days-4-nights/free-day-for-acclimatization.jpg" alt="Free day for acclimatization." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
                ...
                <div class="col-md-10"> 
                 <div class="form_title"><h3><strong><i class="icon_set_1_icon-68"></i></strong><span>Day 2</span></h3> 
					...
					<ul class="list_icons">
                        ...
                        <li><i class="icon-ok-squared"></i>Morning free to rest or visit the museums.</li>
                        <li><i class="icon-ok-squared"></i>In the afternoon we will pick you up at your hotel at 13:30.</li>
				...
				<div class="row magnific-gallery">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/tours-machu-picchu/classic-cusco-conventional-5-days-4-nights/temple-of-the-sun-coricancha.jpg" title="Archaeological Complex of coricancha."><img src="../img/tours-machu-picchu/classic-cusco-conventional-5-days-4-nights/temple-of-the-sun-coricancha.jpg" alt="Archaeological Complex of coricancha." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/tours-machu-picchu/classic-cusco-conventional-5-days-4-nights/archaeological-complex-of-sacsayhuaman.jpg" title="Archaeological Complex of sacsayhuaman."><img src="../img/tours-machu-picchu/classic-cusco-conventional-5-days-4-nights/archaeological-complex-of-sacsayhuaman.jpg" alt="Archaeological Complex of sacsayhuaman." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
                ...
                <div class="col-md-10"> 
                 <div class="form_title"><h3><strong><i class="icon_set_1_icon-68"></i></strong><span>Day 3</span></h3> 
					...
					<ul class="list_icons">
                        ...
                        <li><i class="icon-ok-squared"></i>Visit: Corao Market, Pisac Market, archaeological remains of Pisac, archaeological complex of Ollantaytambo and the archaeological site of Chinchero.</li>
                        <li><i class="icon-ok-squared"></i>The Return to Cusco will be approximately at 7:00 p.m.</li>
                        <li><i class="icon-ok-squared"></i>Spend the night in cusco.</li>
					</ul>
					<div class="row magnific-gallery">
						<div class="col-md-4 col-sm-4">
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/tours-machu-picchu/classic-cusco-conventional-5-days-4-nights/archaeological-complex-of-pisac.jpg" title="Archaeological Site of Pisac."><img src="../img/tours-machu-picchu/classic-cusco-conventional-5-days-4-nights/archaeological-complex-of-pisac.jpg" alt="Archaeological Site of Pisac." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/tours-machu-picchu/classic-cusco-conventional-5-days-4-nights/archaeological-complex-of-chinchero.jpg" title="Archaeological Complex and city of Chinchero."><img src="../img/tours-machu-picchu/classic-cusco-conventional-5-days-4-nights/archaeological-complex-of-chinchero.jpg" alt="Archaeological Complex and city of Chinchero." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
                ...
                <div class="col-md-10"> 
                 <div class="form_title"><h3><strong><i class="icon_set_1_icon-68"></i></strong><span>Day 4</span></h3> 
					...
					<ul class="list_icons">
                        ...
                        <li><i class="icon-ok-squared"></i>The train will leave Aguas Calientes - Ollantaytambo at 18:20 and arrived at 20:15.</li>
					...
					<div class="row magnific-gallery">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/tours-machu-picchu/classic-cusco-conventional-5-days-4-nights/the-intihuatana.jpg" title="The Intihuatana."><img src="../img/tours-machu-picchu/classic-cusco-conventional-5-days-4-nights/the-intihuatana.jpg" alt="The Intihuatana." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/tours-machu-picchu/classic-cusco-conventional-5-days-4-nights/the.sun-temple.jpg" title="Sun Temple."><img src="../img/tours-machu-picchu/classic-cusco-conventional-5-days-4-nights/the.sun-temple.jpg" alt="Sun Temple." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
                ...
                <div class="col-md-10"> 
                 <div class="form_title"><h3><strong><i class="icon_set_1_icon-68"></i></strong><span>Day 5</span></h3> 
					...
					<div class="row magnific-gallery">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/tours-machu-picchu/classic-cusco-conventional-5-days-4-nights/breakfast-at-the-hotel.jpg" title="Breakfast at the Hotel."><img src="../img/tours-machu-picchu/classic-cusco-conventional-5-days-4-nights/breakfast-at-the-hotel.jpg" alt="Breakfast at the Hotel." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/tours-machu-picchu/classic-cusco-conventional-5-days-4-nights/hotel-exit.jpg" title="Hotel exit."><img src="../img/tours-machu-picchu/classic-cusco-conventional-5-days-4-nights/hotel-exit.jpg" alt="Hotel exit." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/tours-machu-picchu/classic-cusco-conventional-5-days-4-nights/airport-transfer.jpg" title="Airport transfer."><img src="../img/tours-machu-picchu/classic-cusco-conventional-5-days-4-nights/airport-transfer.jpg" alt="Airport transfer." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
           ...
           <div class="row">
                ...
                <div class="col-md-10"> <a href="https://www.google.com/maps/d/embed?mid=1IRy2jqSVdpjLT7Xk7t-IBh7dUBE" target="_blank"><img src="../img/see map.png"></a>  
                </div>    
            </div>
            <hr>
