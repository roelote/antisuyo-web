...
if(mail($para, $asunto, $mensaje, $headers)){
    ...
    $estado='Gracias '.$nombre_completo;
	$estado2='Su reserva fue enviado exitosamente¡¡¡¡';
	$estado3="La reserva de <a href='$url_completo'> <strong>$nombre_paquete</strong></a> ha sido emitida correctamente, su respuesta sera inmediata.";
	$estado4="<i class='icon-ok'></i>";
}else{
	$estado='ERROR! '.$nombre_completo;
	$estado2='Su reserva no fue enviado intentar nuevamente';
	$estado3="La reserva de <a href='$url_completo'> <strong>$nombre_paquete</strong></a> no fue emitida correctamente. <a href='$url_completo'> <strong> click aquí <i class='icon_set_1_icon-56'></i></strong></a> para volver a intentar";
...
<html lang="es">
 <head>
    ...
    <title>Reserva <?php echo $nombre_paquete ?> | Antisuyo trek Perú | Agencias de viajes en Perú</title>
...
<body>
	...
	<div class="intro_title animated fadeInDown">
           <h1>ORDEN DE COTIZACIÓN</h1>
            <div class="bs-wizard">
  			
                <div class="col-xs-4 bs-wizard-step complete">
                  <div class="text-center bs-wizard-stepnum">Paquete</div>
	...
	<div class="row">
		<div class="col-md-9 add_bottom_15"> 
			...
			<div class="form_title">
				...
				<p>Datos en enviados al centro de reserva</p>
			</div>
			<div class="step">
				<table class="table table-striped">
					<thead>
					<tr>
						<th colspan="2">Paquete <?php echo($nombre_paquete); ?></th>
					</tr>
					</thead>
					<tbody>
					<tr>
        		...
        		<a class="btn_full_outline" href="http://antisuyotrekperu.com/espanol/"><i class=" icon-heart"></i>Volver a Inicio</a>
			</div> 
	    </div>
		<aside class="col-md-3"> 
			<?php include("includes/costados/paquete-plus.php"); ?>
		</aside>
	</div> 
</div>
...
echo '<meta http-equiv="Refresh" content="0.2;url=http://www.antisuyotrekperu.com/es">';	
} 
?>