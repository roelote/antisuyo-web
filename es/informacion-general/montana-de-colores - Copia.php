        ...
        <div class="col-md-9" id="single_tour_desc">
            <div class="row">
                ...
                <div class="col-md-10 descripcion">
                    ...
                    <p>El Valle de Lares se ubica en el distrito cusqueño de Lares. Este es un estupendo lugar para realizar caminatas, y de hecho comprende circuitos de trekking cuya dificultad varía, dependiendo de la zona que se elija, así como de los días, para seguir el recorrido.</p> 
                </div> 
            </div>
            <hr> 
			<div class="row">
