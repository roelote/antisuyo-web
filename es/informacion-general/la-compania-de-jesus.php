...
<head>
    ...
    <title>Blog La Compania de jesus | Antisuyo Trek Perú | Agencia de viajes y turismo en Perú</title> 
        ...
        <div class="col-md-9" id="single_tour_desc">
            <div class="row">
                ...
                <div class="col-md-10 descripcion">
                    <h4>La compania de jesus</h4>
                    <p>La <strong>Iglesia de la Compañía de Jesús</strong> es una <strong>iglesia jesuita</strong> levantada en la <strong>ciudad de Cuzco</strong>, en el Perú. Fue construida en el sitio de la Amarucancha, el palacio de <strong>Huayna Cápac</strong>. Está en la <strong>Plaza de Armas</strong>, en el <strong>centro de la ciudad</strong>. Es un ejemplo de la arquitectura barroca andina.Su construcción comenzó en 1576, pero fue dañada gravemente en un terremoto en 1650. <strong>La iglesia</strong> reconstruida fue terminada casi dos décadas más adelante. La obra de arte más notable de la iglesia es una pintura que representa el matrimonio de <strong>Martín García</strong> de <strong>Loyola</strong>, sobrino de Ignacio de <strong>Loyola</strong> a Beatriz.</p> 
                </div> 
            </div>
            <hr> 
			<div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-10 descripcion">  
                    <p>Adulto parcial: S/ 10.00</p>
                    <p>Estudiante Parcial: S/ 5.00</p>
                </div><!-- End col-md-9  -->
            </div>
			<hr>
            <div class="row">
                ...
                <div class="col-md-10 descripcion">
                    <p>Allí, tras una larga deliberación espiritual, decidieron fundar la Compañía de Jesús, que fue aprobada el 27 de septiembre de 1540 por Paulo III, quien les reconoció como nueva orden religiosa y firmó la bula de confirmación, Regimini militantis ecclesiae (Por el gobierno de la iglesia militante).</p> 
                </div><!-- End col-md-9  -->
            </div>
