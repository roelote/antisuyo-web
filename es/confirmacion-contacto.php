...
if(mail($para, $asunto, $mensaje, $headers)){
	...
	$estado3="La reserva de <strong>$nombre_paquete</strong> ha sido emitida correctamente, su respuesta sera inmediata.";
	$estado4="<i class='icon-ok'></i>";
}else{
	$estado='ERROR! '.$nombre_completo;
	$estado2='Su reserva no fue enviado intentar nuevamente';
	$estado3="La reserva de <strong>$nombre_paquete</strong> no fue emitida correctamente. <a href='$url_completo'> <strong> click aquí <i class='icon_set_1_icon-56'></i></strong></a> para volver a intentar";
...
echo '<meta http-equiv="Refresh" content="0.2;url=https://www.antisuyotrekperu.com//espanol/">';	
} 
?>