...
$url_foto_seo="https://www.antisuyotrekperu.com/es/img/tours-machu-picchu/cusco-clasico-con-pernocte 4-dias-3-noches/complejo-arqueologico-de-tambomachay.jpg";
?> 
<!DOCTYPE html>
...
<![endif]-->
    ...
    <?php include("includes/menu.php"); ?>
      <section class="slider-tours">
                ...
                <?php   $url_s = "tours-machu-picchu/cusco-clasico-con-pernocte 4-dias-3-noches.jpg";
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-4">
                    <div id="price_single_main" class="hotel">
                        Precio Desde<span><sup>$</sup>455</span>Por persona
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-9" id="single_tour_desc">
            ...
            <div class="row">
                ...
                <div class="col-md-10 descripcion"> 
					 <p>El paquete Cusco Clásico con Pernocte <strong>Machu Picchu </strong>4 días y 3 noches, es una opción maravillosa para conocer el <strong>santuario histórico</strong> de <strong>Machu Picchu</strong>, ya que pernoctaremos en el poblado de <strong>Aguas Calientes</strong> que está localizado cerca al santuario de <strong>Machu Picchu</strong>, lo que nos permitirá ser los primeros en ascender a <strong>Machu Picchu</strong>, para ver la salida del sol y tomar fotos sin mucha gente alrededor.</P> <p><strong>Machu Picchu</strong> es considerada una obra maestra de la arquitectura y la ingeniería. Sus peculiares características arquitectónicas y paisajísticas, lo han convertido en uno de los destinos turísticos más populares del planeta.</p><p>Se cree que <strong>Machu Picchu</strong> tuvo una población móvil como la mayoría de las llactas incas, que oscilaba entre 300 y 1000 habitantes pertenecientes a una élite (posiblemente miembros de <strong>la Panaca</strong> de <strong>Pachacutec</strong>.</p><p><strong>Machu Picchu</strong> está en la Lista del <strong>Patrimonio de la Humanidad</strong> de la Unesco desde 1983, como parte de todo un conjunto cultural y ecológico, conocido bajo la denominación de Santuario Histórico de <strong>Machu Picchu</strong>.</p><p> El 7 de julio de 2007 <strong>Machu Picchu</strong> fue declarada como una de las siete maravillas del <strong>Mundo Moderno</strong>, en una ceremonia realizada en <strong>Lisboa</strong>, <strong>Portugal</strong>, que contó con la participación de cien millones de votantes en el mundo entero, eligiendo a <strong>Machu Picchu</strong> como uno de ellas.</p>
            ...
            <div class="row">
                ...
                <div class="form_title"><h3><strong><i class="icon_set_1_icon-68"></i></strong><span>Día 1</span></h3> 
					...
					<ul class="list_icons">
						...
						<li><i class="icon-ok-squared"></i>Salida a City Tour Arqueológico desde las 14:00 hasta las 18:30.</li>
					...
					<div class="row magnific-gallery">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/tours-machu-picchu/cusco-clasico-con-pernocte 4-dias-3-noches/complejo-arqueologico-de-sacsayhuaman.jpg" title="Complejo Arqueologico de Sacsayhuaman"><img src="img/tours-machu-picchu/cusco-clasico-con-pernocte 4-dias-3-noches/complejo-arqueologico-de-sacsayhuaman.jpg" alt="Complejo Arqueológico de Sacsayhuaman" class="img-responsive">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/tours-machu-picchu/cusco-clasico-con-pernocte 4-dias-3-noches/complejo-arqueologico-de-tambomachay.jpg" title="Complejo Arqueológico de Tambomachay"><img src="img/tours-machu-picchu/cusco-clasico-con-pernocte 4-dias-3-noches/complejo-arqueologico-de-tambomachay.jpg" alt="Complejo Arqueologico de Tambomachay" class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
                ...
                <div class="form_title"><h3><strong><i class="icon_set_1_icon-68"></i></strong><span>Día 2</span></h3> 
					...
					<ul class="list_icons">
						...
						<li><i class="icon-ok-squared"></i>Salida hacia el Valle Sagrado de los Incas a las 08:45 a.m.0</li>
						<li><i class="icon-ok-squared"></i>Visita: Mercados de Corao y Pisac, el complejo arqueológico de Pisac y Ollantaytambo.</li>
					...
					<div class="row magnific-gallery">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/tours-machu-picchu/cusco-clasico-con-pernocte 4-dias-3-noches/valle-de-los-sagrado.jpg" title="Valle Sagrado de los Incas."><img src="img/tours-machu-picchu/cusco-clasico-con-pernocte 4-dias-3-noches/valle-de-los-sagrado.jpg" alt="Valle Sagrado de los Incas." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/tours-machu-picchu/cusco-clasico-con-pernocte 4-dias-3-noches/complejo-arqueologico-de-pisac.jpg" title="Complejo Arqueológico de Pisac."><img src="img/tours-machu-picchu/cusco-clasico-con-pernocte 4-dias-3-noches/complejo-arqueologico-de-pisac.jpg" title="Complejo Arqueológico de Pisac." alt="Complejo Arqueológico de Pisac." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
                ...
                <div class="form_title"><h3><strong><i class="icon_set_1_icon-68"></i></strong><span>Día 3</span></h3> 
					...
					<ul class="list_icons">
						...
						<li><i class="icon-ok-squared"></i>Visita guiada a Machu Picchu durante 2 horas.</li>
						...
						<li><i class="icon-ok-squared"></i>Traslado en nuestro autobús Ollantaytambo - Cusco.</li>
						<li><i class="icon-ok-squared"></i>Pernocte en Cusco.</li>
					</ul>
					<div class="row magnific-gallery">
						<div class="col-md-4 col-sm-4">
            ...
            <div class="row">
                ...
                <div class="col-md-10">
					 <ul class="list_icons"> 
						...
						<li><i class="icon-ok-circle-1"></i>Transporte turistico para cada tour.</li>
						<li><i class="icon-ok-circle-1"></i>Guías profesionales para cada tour.</li>
						...
						<li><i class="icon-ok-circle-1"></i>3 Noches de hotel en Cusco.</li>
            ...
            <div class="row">
                ...
                <div class="col-md-10"> 
					<ul class="list_icons">
						...
						<li><i class="icon-cancel-circle-2"></i>Boleto turístico $ 45.</li> 
						<li><i class="icon-cancel-circle-2"></i>Otros no mencionan.</li> 
