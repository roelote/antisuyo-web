<?php
$nombre_paquete = 'Cusco Clásico Moderno';
$numero_dias='3 días y 2 noches';
$nombre_completo_paquete=$nombre_paquete." ".$numero_dias;
$descripcion_tour="El paquete Cusco Clásico Moderno Machu Picchu 3 días y 2 noches, es una opción para aquellas persona que están de paso por la ciudad de Cusco y desean el santuario histórico de Machu Picchu. Machu Picchu está en la Lista del Patrimonio de la Humanidad de la Unesco desde 1983, como parte de todo un conjunto cultural y ecológico, conocido bajo la denominación de Santuario Histórico de Machu Picchu.";
...
$url_foto_seo="https://www.antisuyotrekperu.com/es/img/tours-machu-picchu/cusco-clasíco-moderno-3-dias-2-noches/templo-del-sol-koricancha.jpg";
?>
<!DOCTYPE html>
...
<![endif]-->
    ...
    <?php include("includes/menu.php"); ?> 
      <section class="slider-tours">
                ...
                <?php   $url_s = "tours-machu-picchu/cusco-clasíco-moderno-3-dias-2-noches.jpg";
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-4">
                    <div id="price_single_main" class="hotel">
                        Precio Desde<span><sup>$</sup>375</span>Por persona
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-9" id="single_tour_desc">
            ...
            <div class="row">
                ...
                <div class="col-md-10 descripcion"> 
					 <p>El paquete Cusco Clásico Moderno <strong>Machu Picchu</strong> 3 días y 2 noches, es una opción para aquellas persona que están de paso por la ciudad de Cusco y desean el <strong>santuario histórico</strong> de <strong>Machu Picchu</strong>.</p>
					 <p><strong>Machu Picchu</strong> está en la Lista del <strong>Patrimonio de la Humanidad</strong> de la Unesco desde 1983, como parte de todo un conjunto cultural y ecológico, conocido bajo la denominación de <strong>Santuario Histórico</strong> de <strong>Machu Picchu</strong>. El 7 de julio de 2007 <strong>Machu Picchu</strong> fue declarada como una de las siete <strong>maravillas del Mundo</strong> Moderno, en una ceremonia realizada en Lisboa, Portugal, que contó con la participación de cien millones de votantes en el mundo entero, eligiendo a <strong>Machu Picchu</strong> como uno de ellas.</p>
               		<p><strong>Machu Picchu</strong> es considerada una obra maestra de la arquitectura y la ingeniería. Sus peculiares características arquitectónicas y paisajísticas, lo han convertido en uno de los destinos turísticos más populares del planeta.</p> 
                </div>
            </div>            
          	<hr>            
            <div class="row">
					...
					<div class="row magnific-gallery">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/tours-machu-picchu/cusco-clasico-moderno-3-dias-2-noches/templo-del-sol-koricancha.jpg" title="Templo del sol Koricancha."><img src="img/tours-machu-picchu/cusco-clasico-moderno-3-dias-2-noches/templo-del-sol-koricancha.jpg" alt="Templo del sol Koricancha." class="img-responsive">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/tours-machu-picchu/cusco-clasico-moderno-3-dias-2-noches/complejo-arqueologico-de-sacsayhuaman.jpg" title="Complejo Arqueológico de Sacsayhuaman"><img src="img/tours-machu-picchu/cusco-clasico-moderno-3-dias-2-noches/complejo-arqueologico-de-sacsayhuaman.jpg" alt="Complejo Arqueológico de Sacsayhuaman" class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/tours-machu-picchu/cusco-clasico-moderno-3-dias-2-noches/complejo-arqueologico-de-tambomachay.jpg" title="Complejo Arqueológico de Tambomachay"><img src="img/tours-machu-picchu/cusco-clasico-moderno-3-dias-2-noches/complejo-arqueologico-de-tambomachay.jpg" alt="Complejo Arqueológico de Tambomachay" class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
                ...
                <div class="form_title"><h3><strong><i class="icon_set_1_icon-68"></i></strong><span>Día 2</span></h3> 
					...
					<ul class="list_icons">
						...
						<li><i class="icon-ok-squared"></i>Traslado de Cusco - Ollantaytambo 1:30 de viaje.</li>
					...
					<div class="row magnific-gallery">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/tours-machu-picchu/cusco-clasico-moderno-3-dias-2-noches/complejo-arqueologico-de-machu-picchu.jpg" title="Complejo Arqueológico de Machu Picchu."><img src="img/tours-machu-picchu/cusco-clasico-moderno-3-dias-2-noches/complejo-arqueologico-de-machu-picchu.jpg" alt="Complejo Arqueológico de Machu Picchu" class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/tours-machu-picchu/cusco-clasico-moderno-3-dias-2-noches/the-intiwatana.jpg" title="El Intihuatana."><img src="img/tours-machu-picchu/cusco-clasico-moderno-3-dias-2-noches/the-intiwatana.jpg" alt="El Intihuatana." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/tours-machu-picchu/cusco-clasico-moderno-3-dias-2-noches/templo-del-sol.jpg" title="Templo del Sol."><img src="img/tours-machu-picchu/cusco-clasico-moderno-3-dias-2-noches/templo-del-sol.jpg" alt="Templo del Sol." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
                ...
                <div class="form_title"><h3><strong><i class="icon_set_1_icon-68"></i></strong><span>Día 3</span></h3> 
					...
					<div class="row magnific-gallery">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/tours-machu-picchu/cusco-clasico-moderno-3-dias-2-noches/desayuno.jpg" title="Desayuno en el Hotel."><img src="img/tours-machu-picchu/cusco-clasico-moderno-3-dias-2-noches/desayuno.jpg" alt="Desayuno en el Hotel." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/tours-machu-picchu/cusco-clasico-moderno-3-dias-2-noches/hotel-salida-del-hotel.jpg" title="Traslado del Hotel."><img src="img/tours-machu-picchu/cusco-clasico-moderno-3-dias-2-noches/hotel-salida-del-hotel.jpg" title="Salida del Hotel." alt="Traslado del Hotel" class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/tours-machu-picchu/cusco-clasico-moderno-3-dias-2-noches/traslado-aeropuerto.jpg" title="Traslado al Aeropueto."><img src="img/tours-machu-picchu/cusco-clasico-moderno-3-dias-2-noches/traslado-aeropuerto.jpg" alt="Traslado al Aeropueto." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
