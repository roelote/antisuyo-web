...
if(mail($para, $asunto, $mensaje, $headers)){
	...
	$estado3="The reservation of <a href='$url_completo'> <strong>$nombre_paquete</strong></a> has been issued correctly, your response will be immediate.";
...
echo '<meta http-equiv="Refresh" content="0.2;url=http://antisuyotrekperu.com">';	
} 
?>