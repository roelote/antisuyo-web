<?php
$nombre_paquete = 'Cusco Machu Picchu Traditional Classic';
...
$url_foto_seo="https://www.antisuyotrekperu.com/img/tours-machu-picchu/cusco-traditional-classic-4-days-3-nights/archaeological-complex-of-sacsayhuaman.jpg";
...
<![endif]-->
    ...
    <?php include("includes/menu.php"); ?>
      <section class="slider-tours">
        ...
        <div class="fill-tour" style="background-image:url('img/tours-machu-picchu/cusco-traditional-classic-4-days-3-nights.jpg');"></div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-4">
                    <div id="price_single_main" class="hotel">
                       Price from<span><sup>$</sup>465</span>For Person
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-9" id="single_tour_desc">
            ...
            <div class="row">
                ...
                <div class="col-md-10 descripcion"> 
					 <p>The traditional Cusco Package Cusco <strong>Machu Picchu</strong> 4 days and 3 nights is an option to know the differents tourist attractions in the city of Cusco and also the Inca citadel of <strong>Machu Picchu</strong>.</p> 
            ...
            <div class="row">
                ...
                <div class="col-md-10"> 
                 <div class="form_title"><h3><strong><i class="icon_set_1_icon-68"></i></strong><span>Day 1</span></h3> 
					<p>
						RECEPTION IN CUSCO / ARCHAEOLOGICAL CITY TOUR
					</p>
				</div>
					<ul class="list_icons">
				...
				<div class="row magnific-gallery">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/tours-machu-picchu/cusco-traditional-classic-4-days-3-nights/archaeological-complex-of-sacsayhuaman.jpg" title="Archaeological Complex of Sacsayhuaman."><img src="../img/tours-machu-picchu/cusco-traditional-classic-4-days-3-nights/archaeological-complex-of-sacsayhuaman.jpg" title="Archaeological Complex of sacsayhuaman." alt="Archaeological Complex of Sacsayhuaman" class="img-responsive">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/tours-machu-picchu/cusco-traditional-classic-4-days-3-nights/archaeological-complex-of-qenqo.jpg" title="Archaeological Complex of Qenqo."><img src="../img/tours-machu-picchu/cusco-traditional-classic-4-days-3-nights/archaeological-complex-of-qenqo.jpg" title="Archaeological Complex of Qenqo." alt="Archaeological Complex of Qenqo" class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/tours-machu-picchu/cusco-traditional-classic-4-days-3-nights/archaeological-complex-of-tambomachay.jpg" title="Archaeological Complex of Tambomachay."><img src="../img/tours-machu-picchu/cusco-traditional-classic-4-days-3-nights/archaeological-complex-of-tambomachay.jpg" alt="Archaeological Complex of Tambomachay." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
                ...
                <div class="col-md-10"> 
                 <div class="form_title"><h3><strong><i class="icon_set_1_icon-68"></i></strong><span>Day 2</span></h3> 
					...
					<ul class="list_icons">
                        ...
                        <li><i class="icon-ok-squared"></i>Visit: Corao Market, Pisac Market, the archaeological remains of Pisac, Ollantaytambo and Chinchero.</li>
					...
					<div class="row magnific-gallery">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/tours-machu-picchu/cusco-traditional-classic-4-days-3-nights/archaeological-complex-pisac.jpg" title="Archaeological Complex of Pisac."><img src="../img/tours-machu-picchu/cusco-traditional-classic-4-days-3-nights/archaeological-complex-pisac.jpg" title="Archaeological Complex of Pisac." alt="Archaeological Complex of Pisac." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/tours-machu-picchu/cusco-traditional-classic-4-days-3-nights/ollantaytambo.jpg" title="Archaeological Complex of ollantaytambo."><img src="../img/tours-machu-picchu/cusco-traditional-classic-4-days-3-nights/ollantaytambo.jpg" alt="Archaeological Complex of ollantaytambo." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/tours-machu-picchu/cusco-traditional-classic-4-days-3-nights/archaeological-complex-chinchero.jpg" title="Archaeological Complex of Chinchero."><img src="../img/tours-machu-picchu/cusco-traditional-classic-4-days-3-nights/archaeological-complex-chinchero.jpg" alt="Archaeological Complex of Chinchero." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
                ...
                <div class="col-md-10"> 
                 <div class="form_title"><h3><strong><i class="icon_set_1_icon-68"></i></strong><span>Day 3</span></h3> 
					...
					<div class="row magnific-gallery">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/tours-machu-picchu/cusco-traditional-classic-4-days-3-nights/archaeological-complex-of-machu-picchu.jpg" title="Archaeological Complex of Machu Picchu."><img src="../img/tours-machu-picchu/cusco-traditional-classic-4-days-3-nights/archaeological-complex-of-machu-picchu.jpg" alt="Archaeological Complex of Machu Picchu." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/tours-machu-picchu/cusco-traditional-classic-4-days-3-nights/the-intihuatana.jpg" title="The Intihuatana."><img src="../img/tours-machu-picchu/cusco-traditional-classic-4-days-3-nights/the-intihuatana.jpg" alt="The Intihuatana." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/tours-machu-picchu/cusco-traditional-classic-4-days-3-nights/the-sun-temple.jpg" title="Temple Sun."><img src="../img/tours-machu-picchu/cusco-traditional-classic-4-days-3-nights/the-sun-temple.jpg" title="Temple Sun." alt="Airport Transfer" class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
                ...
                <div class="col-md-10"> 
                 <div class="form_title"><h3><strong><i class="icon_set_1_icon-68"></i></strong><span>Day 4</span></h3> 
					...
					<div class="row magnific-gallery">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/tours-machu-picchu/cusco-traditional-classic-4-days-3-nights/breakfast-at-the-hotel.jpg" title="Breakfast at the Hotel."><img src="../img/tours-machu-picchu/cusco-traditional-classic-4-days-3-nights/breakfast-at-the-hotel.jpg" alt="Breakfast at the Hotel." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/tours-machu-picchu/cusco-traditional-classic-4-days-3-nights/hotel.jpg" title="Hotel exit."><img src="../img/tours-machu-picchu/cusco-traditional-classic-4-days-3-nights/hotel.jpg" alt="Hotel Exit." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/tours-machu-picchu/cusco-traditional-classic-4-days-3-nights/airport-transfer.jpg" title="Airport transfer."><img src="../img/tours-machu-picchu/cusco-traditional-classic-4-days-3-nights/airport-transfer.jpg" alt="Airport Transfer." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
           ...
           <div class="row">
                ...
                <div class="col-md-10"> <a href="https://www.google.com/maps/d/embed?mid=1J-W0jx12smPu_plYs5yXahgcINg" target="_blank"><img src="../img/see map.png"></a>  
                </div>    
            </div>
            <hr>
