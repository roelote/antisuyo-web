...
$numero_days='4 Days and 3 Nights';
...
$url_foto_seo="https://www.antisuyotrekperu.com/img/salkantay-treks/camino-salkantay-a-machu-picchu-4-days-3-nights/laguna-de-humantay.jpg";
...
<![endif]-->
    ...
    <?php include("includes/menu.php"); ?>
      <section class="slider-tours">
		...
		<div class="fill-tour" style="background-image:url('img/salkantay-treks/salkantay-trek-machu-picchu-4days.jpg');"></div>
        ...
        <div class="col-md-9" id="single_tour_desc">
            ...
            <div class="row">
                ...
                <div class="col-md-10 descripcion"> 
					 <p><strong>Salkantay</strong> or<strong> Salcantay</strong>, is the second highest mountain in the region of Cusco, belongs also to the chain of <strong>mountains of the Andes</strong>, located approximately to 6271 masl., is surrounded by the snowfall of <strong>Humantay</strong> and others. The Salkantay - <strong>Salcantay</strong> trail runs for 4 days and 3 nights, where you can enjoy spectacular scenery and many exciting experiences.</p>                    
                    ...
                    <p>The temperature in the salkantay road, is between 26 ° C to -5 ° C; With an average altitude of 4,650 masl to 1,800 masl, where we will find mountains, hills, snowfall and forests (dense, arid and fertile) rocky valleys, rivers and waterfalls.</p>
                    <p>The <strong>Salkantay</strong> trail 5 days, has a total of 74 kilometers, we in 4 days will make a total of 50 kilometers of hiking, the rest will complete in land transport, the walk is formed by trails, planes, uphill and down, except for the second Day that is the most tired but not impossible day, will allow us to enjoy the imposing mountain range of the Andes and a natural wealth full of ecosystems that is in our country.</p>
                    <p>The best time to make the <strong>Salkantay</strong> - Salcantay Trail is from the month of April to the month of September, since there is no rainfall on the salkantay road, it is a dry season.</p>
                    <p>The <strong>Salkantay</strong> - Salcantay trail 4 days is a great alternative for those people who have little time or also for those people who did not manage to make the reservations to the classic Inca Trail, where we have daily departures in the indicated months.</p>
                  <p>The Salkantay-Salcantay road includes an overnight stay in a hotel in the town of Aguas Calientes for the third night said hotel is included in the package.</p>
                   </div>
            </div>
          	<hr>
            <div class="row">
					...
					<div class="row magnific-gallery">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/salkantay-treks/camino-salkantay-a-machu-picchu-4-days-3-nights/mollepata.jpg" title="Mollepata."><img src="../img/salkantay-treks/camino-salkantay-a-machu-picchu-4-days-3-nights/mollepata.jpg" alt="Mollepata." class="img-responsive">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/salkantay-treks/camino-salkantay-a-machu-picchu-4-days-3-nights/soraypampa.jpg" title="Soraypampa."><img src="../img/salkantay-treks/camino-salkantay-a-machu-picchu-4-days-3-nights/soraypampa.jpg" alt="Soraypampa." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/salkantay-treks/camino-salkantay-a-machu-picchu-4-days-3-nights/laguna-de-humantay.jpg" title="Humantay Lagoon."><img src="../img/salkantay-treks/camino-salkantay-a-machu-picchu-4-days-3-nights/laguna-de-humantay.jpg" alt="Humantay Lagoon." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
                ...
                <div class="col-md-10"> 
                 <div class="form_title"><h3><strong><i class="icon_set_1_icon-68"></i></strong><span>Day 2</span></h3> 
					...
					<div class="row magnific-gallery">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/salkantay-treks/camino-salkantay-a-machu-picchu-4-days-3-nights/salcantay-road.jpg" title="Salkantay Road."><img src="../img/salkantay-treks/camino-salkantay-a-machu-picchu-4-days-3-nights/salcantay-road.jpg" alt="Salkantay Road." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/salkantay-treks/camino-salkantay-a-machu-picchu-4-days-3-nights/huayracmachay.jpg" title="Huayracmachay."><img src="../img/salkantay-treks/camino-salkantay-a-machu-picchu-4-days-3-nights/huayracmachay.jpg" alt="Huayracmachay." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/salkantay-treks/camino-salkantay-a-machu-picchu-4-days-3-nights/campamento-en-Chaullay.jpg" title="camping in Chaullay"><img src="../img/salkantay-treks/camino-salkantay-a-machu-picchu-4-days-3-nights/campamento-en-Chaullay.jpg" alt="camping in Chaullay." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
                ...
                <div class="col-md-10"> 
                 <div class="form_title"><h3><strong><i class="icon_set_1_icon-68"></i></strong><span>Day 3</span></h3> 
					...
					<ul class="list_icons descripcion">
						<li>After breakfast, we will continue the trip appreciating the diversity of flora and fauna, on the edge of the valley of Santa Teresa. On the way we will pass through plantations of coffee, banana, granadillas, fruit trees and the sacred coca leaf, we will also be able to appreciate the different species of birds, such as: woodpeckers, sparrows, thrush and the traditional national bird, “gallito de las rocas” . At the end we will arrive at Hydroelectric where we will have the last lunch and then we say goodbye to the support staff. Then we will take a transport that will take us from hydroelectric, where we will have the opportunity to take advantage of seeing the landscape of the area, the electricity production plant and we will reach the town of hydroelectric. Then we will have a 2 to 3 hour walk to the town of Aguas Calientes. On arrival at the village of Aguas Calientes we will go directly to the hotel to spend the night, where it is located near the sanctuary of Machu Picchu.</li>
					</ul>
					<div class="table-responsive">
						<table class="table table-striped"> 
						<tbody>
					...
					<div class="row magnific-gallery">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/salkantay-treks/camino-salkantay-a-machu-picchu-4-days-3-nights/camino-salkantay-a-machu-picchu-tren-a-la-hidroelectrica.jpg" title="Train to the Hydroelectric"><img src="../img/salkantay-treks/camino-salkantay-a-machu-picchu-4-days-3-nights/camino-salkantay-a-machu-picchu-tren-a-la-hidroelectrica.jpg" alt="Train to the Hydroelectric." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/salkantay-treks/camino-salkantay-a-machu-picchu-4-days-3-nights/pueblo-de-aguas-calientes.jpg" title="town of Aguas Calientes"><img src="../img/salkantay-treks/camino-salkantay-a-machu-picchu-4-days-3-nights/pueblo-de-aguas-calientes.jpg" alt="town of Aguas Calientes" class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/salkantay-treks/camino-salkantay-a-machu-picchu-4-days-3-nights/clasico-arqueologico-machu-picchu.jpg" title="Archaeological Complex of Machu Picchu."><img src="../img/salkantay-treks/camino-salkantay-a-machu-picchu-4-days-3-nights/clasico-arqueologico-machu-picchu.jpg" alt="Archaeological Complex of Machu Picchu." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
                ...
                <div class="col-md-10"> 
                 <div class="form_title"><h3><strong><i class="icon_set_1_icon-68"></i></strong><span>Day 4</span></h3> 
					...
					<div class="row magnific-gallery">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/salkantay-treks/camino-salkantay-a-machu-picchu-4-days-3-nights/clasico-arqueologico-machu-picchu.jpg" title="Archaeological Site of Machu Picchu."><img src="../img/salkantay-treks/camino-salkantay-a-machu-picchu-4-days-3-nights/clasico-arqueologico-machu-picchu.jpg" alt="Archaeological Site of Machu Picchu." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/salkantay-treks/camino-salkantay-a-machu-picchu-4-days-3-nights/desayuno.jpg" title="Breakfast in hot waters."><img src="../img/salkantay-treks/camino-salkantay-a-machu-picchu-4-days-3-nights/desayuno.jpg" alt="Breakfast in hot waters." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/salkantay-treks/camino-salkantay-a-machu-picchu-4-days-3-nights/bus-de-regreso-a-cusco.jpg" title="Return to Cusco by bus."><img src="../img/salkantay-treks/camino-salkantay-a-machu-picchu-4-days-3-nights/bus-de-regreso-a-cusco.jpg" alt="Return to Cusco by bus." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
            ...
            <div class="row">
                ...
                <div class="col-md-10">
					 <ul class="list_icons">
                        ...
                        <li><i class="icon-ok-circle-1"></i>Professional guide in Englissh.</li>
                        <li><i class="icon-ok-circle-1"></i>Chef: Specialized in Andean gastronomy.</li>
                        <li><i class="icon-ok-circle-1"></i>Horses: for camping and food equipment.</li>
                        <li><i class="icon-ok-circle-1"></i>Camping tent for the paxs; For the guide and cook.</li>
                        <li><i class="icon-ok-circle-1"></i>Camping equipment, Tents, tables, blankets, chairs, dining room, kitchen shop.</li>
                        <li><i class="icon-ok-circle-1"></i>Food 3 breakfasts / 3 lunches / 3 dinners.</li>
                        <li><i class="icon-ok-circle-1"></i>Beach Transportation - Hydroelectric.</li>
                        <li><i class="icon-ok-circle-1"></i>Hotel 1 night in Aguas Calientes.</li>
                        <li><i class="icon-ok-circle-1"></i>Return train ticket (Service Expeditions) from Aguas Calientes  to Ollantaytambo.</li>
                        <li><i class="icon-ok-circle-1"></i>Transportation from Ollantaytambo - Cusco.</li>
