<?php
$nombre_paquete = 'Classic Cusco Machu Picchu Imperial';
$numero_dias='6 Days and 5 Nights';
$nombre_completo_paquete=$nombre_paquete." ".$numero_dias;
$descripcion_tour="This package of 6 days and 5 nights, is a complete alternative to know several tourist sites in the city of Cusco and also at the same time to the historic sanctuary of Machu Picchu, while it is very important to highlight about the walk to Maras Moray and the pits of Sal. Where it shows us a natural attraction that is hardly compared to salt of Uyuni in the neighboring country of Bolivia.";
...
$url_foto_seo="http://antisuyo.trek/img/tours-machu-picchu/cusco-classic-archaeological-5-days-4-nights/free-day-for-acclimatization.jpg";
...
<![endif]-->
    ...
    <div class="fill-tour" style="background-image:url('img/tours-machu-picchu/cusco-machu-picchu-classic-imperial-6days.jpg');"></div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-4">
                    <div id="price_single_main" class="hotel">
                       Price from<span><sup>$</sup>565</span>For Person
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-9" id="single_tour_desc">
            ...
            <div class="row">
                ...
                <div class="col-md-10 descripcion"> 
					 <p>This package of 6 days and 5 nights, is a complete alternative to know several tourist sites in the city of Cusco and also at the same time to the <strong>historic sanctuary of Machu Picchu</strong>, while it is very important to highlight about the walk to<strong> Maras Moray</strong> and the pits of Sal. Where it shows us a natural attraction that is hardly compared to salt of Uyuni in the neighboring country of Bolivia.</p> 
                    ...
                    <p>It is believed that <strong>Machu Picchu</strong> had a population like most “<strong>Llactas Incas</strong>”, that was between the 300 and 1000 inhabitants that were possibly part of the Panaca of Pachacutec.</p>
                    <p><strong>Machu Picchu</strong> has been on UNESCO's World Heritage List since 1983, as part of an entire cultural and ecological complex known as the <strong>Historic Sanctuary of Machu Picchu</strong>. On July 7, 2007, <strong>Machu Picchu</strong> was declared one of the Seven Wonders of the Modern World, at a ceremony held in Lisbon, Portugal, with the participation of one hundred million voters worldwide, choosing<strong> Machu Picchu</strong> as one from them.</p>
                   </div>
            </div>
          	<hr>
            <div class="row">
					...
					<div class="row magnific-gallery">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/tours-machu-picchu/cusco-classic-archaeological-5-days-4-nights/hotel-transfer.jpg" title="Hotel Transfer."><img src="../img/tours-machu-picchu/cusco-classic-archaeological-5-days-4-nights/hotel-transfer.jpg" alt="Hotel Transfer." class="img-responsive">
                ...
                <div class="col-md-10"> 
                 <div class="form_title"><h3><strong><i class="icon_set_1_icon-68"></i></strong><span>Day 2</span></h3> 
					...
					<div class="row magnific-gallery">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/tours-machu-picchu/cusco-classic-archaeological-5-days-4-nights/archaeological-complex-of-qenqo.jpg" title="Temple of the sun coricancha."><img src="../img/tours-machu-picchu/cusco-classic-archaeological-5-days-4-nights/archaeological-complex-of-qenqo.jpg" alt="Archaeological Complex of Qenqo." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/tours-machu-picchu/cusco-classic-archaeological-5-days-4-nights/archaeological-complex-of-qenqo.jpg" title="Archaeological Complex of qenqo."><img src="../img/tours-machu-picchu/cusco-classic-archaeological-5-days-4-nights/archaeological-complex-of-qenqo.jpg" alt="Complejo Arqueológico de qenqo." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
                ...
                <div class="col-md-10"> 
                 <div class="form_title"><h3><strong><i class="icon_set_1_icon-68"></i></strong><span>Day 3</span></h3> 
					<p>CUSCO - MARAS MORAY AND SALINERAS</p>
				</div>
					<ul class="list_icons">
						<li><i class="icon-ok-squared"></i>Breakfast at the Hotel.</li>
                        <li><i class="icon-ok-squared"></i>we will pick you up at your hotel at 08:30 a.m.</li>
                        <li><i class="icon-ok-squared"></i>Departure to Maras Moray and Salineras 09h00 a.m.</li>
                        <li><i class="icon-ok-squared"></i>Visit to the market of Chinchero, the village of Maras, Archaeological complex of Moray, ruins Macho qolqa and salt pits of Maras.</li>
                        <li><i class="icon-ok-squared"></i>Return to Cusco 3:00 pm.</li>
                        <li><i class="icon-ok-squared"></i>Spend the night in cusco.</li>
					</ul>
					<div class="row magnific-gallery">
						<div class="col-md-4 col-sm-4">
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/tours-machu-picchu/cusco-classic-imperial-6-days-5-nights/salineras-de-maras.jpg" title="Maras salt mines."><img src="../img/tours-machu-picchu/cusco-classic-imperial-6-days-5-nights/salineras-de-maras.jpg" alt="Maras salt mines." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/tours-machu-picchu/cusco-classic-imperial-6-days-5-nights/archaeological-complex-of-moray.jpg" title="Moray Archaeological Complex."><img src="../img/tours-machu-picchu/cusco-classic-imperial-6-days-5-nights/archaeological-complex-of-moray.jpg" alt="Moray Archaeological Complex." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/tours-machu-picchu/cusco-classic-imperial-6-days-5-nights/market-of-chinchero.jpg" title="Chincheros Market."><img src="../img/tours-machu-picchu/cusco-classic-imperial-6-days-5-nights/market-of-chinchero.jpg" alt="Chincheros Market." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
                ...
                <div class="col-md-10"> 
                 <div class="form_title"><h3><strong><i class="icon_set_1_icon-68"></i></strong><span>Day 4</span></h3> 
					...
					<ul class="list_icons">
                        ...
                        <li><i class="icon-ok-squared"></i>In the afternoon we will take the train Ollantaytambo - Aguas Calientes at 19:04.</li>
					...
					<div class="row magnific-gallery">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/tours-machu-picchu/cusco-classic-imperial-6-days-5-nights/archaeological-complex-of-pisac.jpg" title="Archaeological Site of Pisac."><img src="../img/tours-machu-picchu/cusco-classic-imperial-6-days-5-nights/archaeological-complex-of-pisac.jpg" alt="Archaeological Site of Pisac." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/tours-machu-picchu/cusco-classic-imperial-6-days-5-nights/archaeological-complex-of-ollantaytambo.jpg" title="Archaeological Complex of Ollantaytambo."><img src="../img/tours-machu-picchu/cusco-classic-imperial-6-days-5-nights/archaeological-complex-of-ollantaytambo.jpg" alt="Archaeological Complex of Ollantaytambo." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/tours-machu-picchu/cusco-classic-imperial-6-days-5-nights/archaeological-complex-of-chinchero.jpg" title="Archaeological Complex and city of Chinchero."><img src="../img/tours-machu-picchu/cusco-classic-imperial-6-days-5-nights/archaeological-complex-of-chinchero.jpg" alt="Archaeological Complex and city of Chinchero." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
                ...
                <div class="col-md-10"> 
                 <div class="form_title"><h3><strong><i class="icon_set_1_icon-68"></i></strong><span>Day 5</span></h3> 
					...
					<ul class="list_icons">
                        ...
                        <li><i class="icon-ok-squared"></i>Then we will take the train from Aguas Calientes - Ollantaytambo at 18:20.</li>
					...
					<div class="row magnific-gallery">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/tours-machu-picchu/cusco-classic-imperial-6-days-5-nights/archaeological-complex-of-machu-picchu.jpg" title="Archaeological Complex of Machu Picchu."><img src="../img/tours-machu-picchu/cusco-classic-imperial-6-days-5-nights/archaeological-complex-of-machu-picchu.jpg" alt="Archaeological Complex of Machu Picchu." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/tours-machu-picchu/cusco-classic-imperial-6-days-5-nights/the-intihuatana.jpg" title="the Intihuatana."><img src="../img/tours-machu-picchu/cusco-classic-imperial-6-days-5-nights/the-intihuatana.jpg" alt="The Intihuatana." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/tours-machu-picchu/cusco-classic-imperial-6-days-5-nights/sun temple.jpg" title="Sun Temple."><img src="../img/tours-machu-picchu/cusco-classic-imperial-6-days-5-nights/sun temple.jpg" alt="Sun Temple." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
                ...
                <div class="col-md-10"> 
                 <div class="form_title"><h3><strong><i class="icon_set_1_icon-68"></i></strong><span>Day 6</span></h3> 
					...
					<div class="row magnific-gallery">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/tours-machu-picchu/cusco-classic-imperial-6-days-5-nights/breakfast-at-the-hotel.jpg" title="Breakfast at the Hotel."><img src="../img/tours-machu-picchu/cusco-classic-imperial-6-days-5-nights/breakfast-at-the-hotel.jpg" alt="Breakfast at the Hotel." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/tours-machu-picchu/cusco-classic-imperial-6-days-5-nights/hotel-exit.jpg" title="Hotel exit."><img src="../img/tours-machu-picchu/cusco-classic-imperial-6-days-5-nights/hotel-exit.jpg" alt="Hotel exi." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="../img/tours-machu-picchu/cusco-classic-imperial-6-days-5-nights/airport-transfer.jpg" title="Airport transfer."><img src="../img/tours-machu-picchu/cusco-classic-imperial-6-days-5-nights/airport-transfer.jpg" alt="Airport transfer." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
           ...
           <div class="row">
                ...
                <div class="col-md-10"> <a href="https://www.google.com/maps/d/embed?mid=1IawH51o2O9Lh2Mxoco3BFAW901E" target="_blank"><img src="../img/see map.png"></a>  
                </div>    
            </div>
            <hr>
