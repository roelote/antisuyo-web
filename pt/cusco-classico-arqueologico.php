<?php
$nombre_paquete = 'Cusco Clássico Arqueológico';
$numero_dias='5 dias e 4 noites';
$nombre_completo_paquete=$nombre_paquete." ".$numero_dias;
$descripcion_tour="Pacote Cusco Clássico Machu Picchu 5 dias e 4 noites, é uma ótima maneira de explorar o santuário histórico de Machu Picchu, como a cidade de Aguas Calientes está localizado perto do santuário de Machu Picchu. Onde subiremos muito cedo para aproveitar ver o nascer do sol e também tomar as primeiras fotos em poucas pessoas.";
...
$url_foto_seo="https://www.antisuyotrekperu.com/pt/img/passeio-machu-picchu/cusco-classico-arqueologico-5-dias-4-noites/complexo-arqueologico-chinchero.jpg";
...
<![endif]-->
    ...
    <?php include("includes/menu.php"); ?> 
      <section class="slider-tours">
                ...
                <?php   $url_s = "passeio-machu-picchu/cusco-classico-arqueologico-5-dias-4-noites.jpg";
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-4">
                    <div id="price_single_main" class="hotel">
                        Preço desde<span><sup>$</sup>410</span>Por pessoa
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row ">
        <div class="col-md-9" id="single_tour_desc">
            ...
            <div class="row">
                ...
                <div class="col-md-10 descripcion"> 
					 ...
					 <p><strong>Machu Picchu</strong> está localizada a 2.490 m, altitude da praça principal, onde seu nome original era Picchu ou Piccho, finalmente chamado pelas montanhas próximas da cidade de <strong>Machu Picchu</strong>.</p>
              		<p>Em 07 de julho de 2007 <strong>Machu Picchu</strong> foi declarado uma das Sete Maravilhas do Mundo Moderno, numa cerimónia feita em Lisboa, Portugal, que teve a participação de uma centena de milhões de eleitores em todo o mundo, a escolha de <strong>Machu Picchu</strong> foi como uma delas.
                    Acredita-se que <strong>Machu Picchu</strong> teve uma população móvel como a maioria dos llactas Incas, variando entre 300 e 1.000 pessoas pertencentes a uma elite (possivelmente membros da Panaca de Pachacutec.</p> 
                </div>
            </div> 
          	<hr> 
            <div class="row">
                ...
                <div class="form_title"><h3><strong><i class="icon_set_1_icon-68"></i></strong><span>Dia 1</span></h3> 
					<p>RECEPÇÂO EM CUSCO / TRANSLADO AO HOTEL</p>
				</div>
					<ul class="list_icons">
					...
					<div class="row magnific-gallery">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/passeio-machu-picchu/cusco-classico-arqueologico-5-dias-4-noites/transfer-aeroporto.jpg" title="Transfer Aeroporto."><img src="img/passeio-machu-picchu/cusco-classico-arqueologico-5-dias-4-noites/transfer-aeroporto.jpg" alt="Transfer Aeroporto." title="machu picchu montaña" class="img-responsive">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/passeio-machu-picchu/cusco-classico-arqueologico-5-dias-4-noites/descanso-en-el-hotel.jpg" title="Descanso en el Hotel."><img src="img/passeio-machu-picchu/cusco-classico-arqueologico-5-dias-4-noites/descanso-en-el-hotel.jpg" alt="Descanso en el Hotel." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/passeio-machu-picchu/cusco-classico-arqueologico-5-dias-4-noites/dia-livre-para-aclimatacao.jpg" title="Dia livre para aclimatação."><img src="img/passeio-machu-picchu/cusco-classico-arqueologico-5-dias-4-noites/dia-livre-para-aclimatacao.jpg" alt="Dia livre para aclimatação." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
                ...
                <div class="form_title"><h3><strong><i class="icon_set_1_icon-68"></i></strong><span>Dia 2</span></h3> 
					...
					<ul class="list_icons">
                        ...
                        <li><i class="icon-ok-squared"></i>A manhã livre, para aproveitar conhecer aos museus da cidade.</li>
					...
					<div class="row magnific-gallery">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/passeio-machu-picchu/cusco-classico-arqueologico-5-dias-4-noites/templo-do-sol-koricancha.jpg" title="Templo do Sol Koricancha."><img src="img/passeio-machu-picchu/cusco-classico-arqueologico-5-dias-4-noites/templo-do-sol-koricancha.jpg" title="Templo do Sol Koricancha" alt="Templo do Sol Koricancha." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/passeio-machu-picchu/cusco-classico-arqueologico-5-dias-4-noites/complexo-arqueologico-de-sacsayhuaman.jpg" title="Complexo arqueológico de Sacsayhuaman."><img src="img/passeio-machu-picchu/cusco-classico-arqueologico-5-dias-4-noites/complexo-arqueologico-de-sacsayhuaman.jpg" title="Complexo arqueológico de Sacsayhuaman." alt="Complexo arqueológico de Sacsayhuaman." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/passeio-machu-picchu/cusco-classico-arqueologico-5-dias-4-noites/complexo-arqueologico-de-qenqo.jpg" title="Complexo Arqueológico de  Qenqo."><img src="img/passeio-machu-picchu/cusco-classico-arqueologico-5-dias-4-noites/complexo-arqueologico-de-qenqo.jpg" alt="Complexo Arqueológico de  Qenqo." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
                ...
                <div class="form_title"><h3><strong><i class="icon_set_1_icon-68"></i></strong><span>Dia 3</span></h3> 
					...
					<div class="row magnific-gallery">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/passeio-machu-picchu/cusco-classico-arqueologico-5-dias-4-noites/complexo-arqueologico-de-pisac.jpg" title="Complexo Arqueológico de  Pisac."><img src="img/passeio-machu-picchu/cusco-classico-arqueologico-5-dias-4-noites/complexo-arqueologico-de-pisac.jpg" alt="Complexo Arqueológico de Pisac." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/passeio-machu-picchu/cusco-classico-arqueologico-5-dias-4-noites/complexo-arqueologico-ollantaytambo.jpg" title="Complexo Arqueológico de Ollantaytambo."><img src="img/passeio-machu-picchu/cusco-classico-arqueologico-5-dias-4-noites/complexo-arqueologico-ollantaytambo.jpg" alt="Complexo Arqueológico de Ollantaytambo." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/passeio-machu-picchu/cusco-classico-arqueologico-5-dias-4-noites/complexo-arqueologico-chinchero.jpg" title="Complexo Arqueológico de  Chinchero."><img src="img/passeio-machu-picchu/cusco-classico-arqueologico-5-dias-4-noites/complexo-arqueologico-chinchero.jpg" alt="Complexo Arqueológico de  Chinchero." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
                ...
                <div class="form_title"><h3><strong><i class="icon_set_1_icon-68"></i></strong><span>Dia 4</span></h3> 
					...
					<div class="row magnific-gallery">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/passeio-machu-picchu/cusco-classico-arqueologico-5-dias-4-noites/sitio-arqueologico-machu-picchu.jpg" title="Sitio Arqueologica de Machu Picchu."><img src="img/passeio-machu-picchu/cusco-classico-arqueologico-5-dias-4-noites/sitio-arqueologico-machu-picchu.jpg" alt="Sitio Arqueologica de Machu Picchu." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/passeio-machu-picchu/cusco-classico-arqueologico-5-dias-4-noites/o-intihuatana.jpg" title="O Intihuatana."><img src="img/passeio-machu-picchu/cusco-classico-arqueologico-5-dias-4-noites/o-intihuatana.jpg" alt="O Intihuatana." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/passeio-machu-picchu/cusco-classico-arqueologico-5-dias-4-noites/templo-do-sol.jpg" title="Templo do Sol."><img src="img/passeio-machu-picchu/cusco-classico-arqueologico-5-dias-4-noites/templo-do-sol.jpg" alt="Templo do Sol." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
                ...
                <div class="form_title"><h3><strong><i class="icon_set_1_icon-68"></i></strong><span>Dia 5</span></h3> 
					...
					<div class="row magnific-gallery">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/passeio-machu-picchu/cusco-classico-arqueologico-5-dias-4-noites/cafe-da-manha-no-hotel.jpg" title="Café da manhã no Hotel."><img src="img/passeio-machu-picchu/cusco-classico-arqueologico-5-dias-4-noites/cafe-da-manha-no-hotel.jpg" alt="Café da manhã no Hotel." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/passeio-machu-picchu/cusco-classico-arqueologico-5-dias-4-noites/saida-de-seu-voo.jpg" title="saída de seu voo."><img src="img/passeio-machu-picchu/cusco-classico-arqueologico-5-dias-4-noites/saida-de-seu-voo.jpg" alt="saída de seu voo." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/passeio-machu-picchu/cusco-classico-arqueologico-5-dias-4-noites/translado-ao-aeroporto.jpg" title="Translado ao Aeroporto."><img src="img/passeio-machu-picchu/cusco-classico-arqueologico-5-dias-4-noites/translado-ao-aeroporto.jpg" alt="Translado ao Aeroporto." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
            ...
            <div class="row">
                ...
                <div class="col-md-10"> 
					<ul class="list_icons">
						<li><i class="icon-cancel-circle-2"></i>Café da manhã do 1º dia, almoço do último dia e Janta .</li>
                        <li><i class="icon-cancel-circle-2"></i>Ônibus para subir e descer de Machu Picchu - Águas Caliente</li>
                        <li><i class="icon-cancel-circle-2"></i>O outro que não estão acima.</li>
