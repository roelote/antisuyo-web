...
$descripcion_tour="Trilha Salkantay é um nevado que está a, aproximadamente, 6.271 metros acima do nível do mar. Ao seu redor, se vê o nevado de Umantay e outros. A Trilha por Salkantay tem uma duração de 5 dias e 4 noites, onde você desfrutará de paisagens espetaculares e viverá muitas experiências emocionantes.";
...
$url_foto_seo="https://www.antisuyotrekperu.com/pt/img/trilha-salkantay/camino-salkantay-a-machu-picchu-5-dias-4-noites/mollepata.jpg";
...
<![endif]-->
    ...
    <?php include("includes/menu.php"); ?>
      <section class="slider-tours">
                ...
                <?php   $url_s = "trilha-salkantay/camino-salkantay-a-machu-picchu-5-dias-4-noites.jpg";
            ...
            <div class="row">
					...
					<div class="row magnific-gallery">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/trilha-salkantay/camino-salkantay-a-machu-picchu-5-dias-4-noites/mollepata.jpg" title="Mollepata."><img src="img/trilha-salkantay/camino-salkantay-a-machu-picchu-5-dias-4-noites/mollepata.jpg" alt="Mollepata." class="img-responsive">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/trilha-salkantay/camino-salkantay-a-machu-picchu-5-dias-4-noites/soraypampa.jpg" title="Campamento de soraypampa."><img src="img/trilha-salkantay/camino-salkantay-a-machu-picchu-5-dias-4-noites/soraypampa.jpg" alt="Campamento de soraypampa." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/trilha-salkantay/camino-salkantay-a-machu-picchu-5-dias-4-noites/laguna-de-humantay.jpg" title="Laguna de Humantay."><img src="img/trilha-salkantay/camino-salkantay-a-machu-picchu-5-dias-4-noites/laguna-de-humantay.jpg" alt="Laguna de Humantay." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
                ...
                <div class="form_title"><h3><strong><i class="icon_set_1_icon-68"></i></strong><span>Dia 2</span></h3> 
					...
					<div class="row magnific-gallery">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/trilha-salkantay/camino-salkantay-a-machu-picchu-5-dias-4-noites/nevado-salkantay.jpg" title="Nevado de Salkantay."><img src="img/trilha-salkantay/camino-salkantay-a-machu-picchu-5-dias-4-noites/nevado-salkantay.jpg" alt="Nevado de Salkantay." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/trilha-salkantay/camino-salkantay-a-machu-picchu-5-dias-4-noites/huayracmachay.jpg" title="Huayracmachay."><img src="img/trilha-salkantay/camino-salkantay-a-machu-picchu-5-dias-4-noites/huayracmachay.jpg" alt="Huayracmachay." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/trilha-salkantay/camino-salkantay-a-machu-picchu-5-dias-4-noites/campamento-en-chaullay.jpg" title="Campamento en Chaullay."><img src="img/trilha-salkantay/camino-salkantay-a-machu-picchu-5-dias-4-noites/campamento-en-chaullay.jpg" alt="Campamento en Chaullay." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
                ...
                <div class="form_title"><h3><strong><i class="icon_set_1_icon-68"></i></strong><span>Dia 3</span></h3> 
					...
					<div class="row magnific-gallery">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/trilha-salkantay/camino-salkantay-a-machu-picchu-5-dias-4-noites/santa-teresa.jpg" title="Vale de Santa Teresa."><img src="img/trilha-salkantay/camino-salkantay-a-machu-picchu-5-dias-4-noites/santa-teresa.jpg" alt="Vale de Santa Teresa." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/trilha-salkantay/camino-salkantay-a-machu-picchu-5-dias-4-noites/banos-termo-medicinales-de-cocalmayo.jpg" title="Banhos medicinais terapêuticos de Cocalmayo."><img src="img/trilha-salkantay/camino-salkantay-a-machu-picchu-5-dias-4-noites/banos-termo-medicinales-de-cocalmayo.jpg" alt="Banhos medicinais terapêuticos de Cocalmayo." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/trilha-salkantay/camino-salkantay-a-machu-picchu-5-dias-4-noites/acampamento-para-a-noite.jpg" title="Acampamento para a noite."><img src="img/trilha-salkantay/camino-salkantay-a-machu-picchu-5-dias-4-noites/acampamento-para-a-noite.jpg" alt="Acampamento para a noite." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
                ...
                <div class="form_title"><h3><strong><i class="icon_set_1_icon-68"></i></strong><span>Dia 4</span></h3> 
					...
					<div class="row magnific-gallery">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/trilha-salkantay/camino-salkantay-a-machu-picchu-5-dias-4-noites/tren-a-la-hidroelectrica.jpg" title="Tren a la Hidroeléctrica."><img src="img/trilha-salkantay/camino-salkantay-a-machu-picchu-5-dias-4-noites/tren-a-la-hidroelectrica.jpg" alt="Tren a la Hidroeléctrica." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/trilha-salkantay/camino-salkantay-a-machu-picchu-5-dias-4-noites/pueblo-de-aguas-calientes.jpg" title="pueblo de Aguas Calientes."><img src="img/trilha-salkantay/camino-salkantay-a-machu-picchu-5-dias-4-noites/pueblo-de-aguas-calientes.jpg" alt="pueblo de Aguas Calientes." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/trilha-salkantay/camino-salkantay-a-machu-picchu-5-dias-4-noites/sitio-arqueologico-machu-picchu.jpg" title="Complexo Arqueologico de Machu Picchu."><img src="img/trilha-salkantay/camino-salkantay-a-machu-picchu-5-dias-4-noites/sitio-arqueologico-machu-picchu.jpg" alt="Complexo Arqueologico de Machu Picchu." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
                ...
                <div class="form_title"><h3><strong><i class="icon_set_1_icon-68"></i></strong><span>Dia 5</span></h3> 
					...
					<div class="row magnific-gallery">
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/trilha-salkantay/camino-salkantay-a-machu-picchu-5-dias-4-noites/sitio-arqueologico-machu-picchu.jpg" title="Sitio Arqueologica de Machu Picchu."><img src="img/trilha-salkantay/camino-salkantay-a-machu-picchu-5-dias-4-noites/sitio-arqueologico-machu-picchu.jpg" alt="Sitio Arqueologica de Machu Picchu." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/trilha-salkantay/camino-salkantay-a-machu-picchu-5-dias-4-noites/desayuno.jpg" title="Desayuno en aguas calientes."><img src="img/trilha-salkantay/camino-salkantay-a-machu-picchu-5-dias-4-noites/desayuno.jpg" alt="Desayuno en aguas calientes." class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
						...
						<div class="img_wrapper_gallery">
							<div class="img_container_gallery">
								<a href="img/trilha-salkantay/camino-salkantay-a-machu-picchu-5-dias-4-noites/bus-de-regreso a cusco.jpg" title="Retorno al cusco en bus."><img src="img/trilha-salkantay/camino-salkantay-a-machu-picchu-5-dias-4-noites/bus-de-regreso a cusco.jpg" class="img-responsive">
									<i class="icon-resize-full-2"></i>
								</a>
							</div>
						</div>
