...
<head>
    ...
    <title>Blog Mercado San Pedro | Antisuyo Trek Perú | Agência de viagens e turismo no Peru</title> 
        ...
        <div class="col-md-9" id="single_tour_desc">
            <div class="row">
                ...
                <div class="col-md-10 descripcion">
                    ...
                    <p>O Mercado de San Pedro foi exclusivo para a venda de alimentos e matérias-primas, para o crescimento turístico hoje você pode encontrar parte de produtos orgânicos como frutas, vegetais, folhas de coca, campo de queijos deliciosos e os rebentos de pão inesquecíveis; roupas, jóias, artesanato, têxteis, instrumentos musicais e muito mais</p> 
                </div> 
            </div>
            <hr> 
			<div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6">
                            <ul class="list-inline">
                                <li><i class="icon_set_1_icon-38"></i>13°31'18.3" Latitude sul</li> 
                            </ul>
                        </div>
                        <div class="col-md-6 col-sm-6">
                            <ul class="list-inline">
                                <li><i class="icon_set_1_icon-38"></i>71°58'56.5" de longitude oeste</li> 
                            </ul>
                        </div>
                    </div> 
                </div> 
            ...
            <div class="row">
                ...
                <div class="col-md-10 descripcion">  
                    <p>De segunda a sábado das 6:30 da manhã às 6:30 p.m. Domingos até meio-dia</p> 
                </div><!-- End col-md-9  -->
            </div>
			<hr>
            <div class="row">
                ...
                <div class="col-md-10 descripcion">
                    <p>A pé da rua Santa Clara a 11 minutos da Plaza de Armas</p> 
                </div><!-- End col-md-9  -->
            </div>
