...
if(mail($para, $asunto, $mensaje, $headers)){
	...
	$estado3="A reserva do <strong>$nombre_paquete</strong> foi emitida corretamente, sua resposta será imediata.";
	$estado4="<i class='icon-ok'></i>";
}else{
	$estado='ERRO! '.$nombre_completo;
	$estado2='Sua reserva não foi enviada para tentar novamente';
	$estado3="A reserva do  <strong>$nombre_paquete</strong> não foi emitido corretamente. <a href='contato.php'> <strong> Clique aqui <i class='icon_set_1_icon-56'></i></strong></a> para volver a intentar";
