...
$asunto = "Reserva de: ".$nombre_completo.' para '.$nombre_paquete;
...
if(mail($para, $asunto, $mensaje, $headers)){
    ...
    $estado='Obrigado '.$nombre_completo;
	$estado2='Sua reserva foi enviada com sucesso¡¡¡¡';
	$estado3="A reserva do <a href='$url_completo'> <strong>$nombre_paquete</strong></a> foi emitida corretamente, sua resposta será imediata.";
	$estado4="<i class='icon-ok'></i>";
}else{
	$estado='ERRO! '.$nombre_completo;
	$estado2='Sua reserva não foi enviada para tentar novamente';
	$estado3="A reserva do <a href='$url_completo'> <strong>$nombre_paquete</strong></a> não foi emitido corretamente. <a href='$url_completo'> <strong> Clique aqui <i class='icon_set_1_icon-56'></i></strong></a> para volver a intentar";
...
<html lang="pt">
 <head>
    ...
    <meta name="description" content="Antisuyo Trek Perú | Agência de viagens e turismo no Peru">
    <meta name="author" content="Antisuyo Trek Perú">
    <title>Reserva <?php echo $nombre_paquete ?> | Antisuyo trek Perú | Agência de viagens e turismo no Peru</title>
 ...
 <div class="container margin_60">
	<div class="row">
		<div class="col-md-9 add_bottom_15"> 
			...
			<div class="form_title">
				<h3><strong><i class="icon-tag-1"></i></strong>Resumo da reserva</h3>
				<p>Dados enviados para o centro de reservas</p>
			</div>
			<div class="step">
				<table class="table table-striped">
					<thead>
					<tr>
						<th colspan="2">Pacote <?php echo($nombre_paquete); ?></th>
					</tr>
					</thead>
					<tbody>
					<tr>
					...
					<tr>
						<td><strong>Data de início da caminhada</strong></td>
					...
					<tr>
						<td><strong>Número de pessoas</strong></td>
						<td><?php echo $_POST['numerodepasajeros']; ?></td>
					</tr>
					</tbody>
				</table> 
        		<a class="btn_full_outline" href="https://www.antisuyotrekperu.com/pt/"><i class=" icon-heart"></i>Voltar para casa</a>
			</div> 
	    </div>
		<aside class="col-md-3"> 
			<?php include("includes/costados/pacote-plus.php"); ?>
		</aside>
	</div> 
</div> 
...
echo '<meta http-equiv="Refresh" content="0.2;url=https://www.antisuyotrekperu.com//portugues/">';	
}  
?>